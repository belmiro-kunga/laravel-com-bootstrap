...
<body>
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('rastreamento.publico') }}" method="GET" class="needs-validation" novalidate>
                                <div class="mb-3">
        ...
        <div class="container py-5">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8" data-aos="zoom-in">
                    ...
                    <a href="{{ route('denuncias.formulario-publico') }}" class="btn btn-light btn-lg px-5">
    ...
    <section class="section cta-section">
        <div class="container text-center">
            <h2 class="mb-4">{{ \App\Helpers\ConfigHelper::get('home_cta_title', 'Pronto para fazer a diferença?') }}</h2>
            <p class="lead mb-4">{{ \App\Helpers\ConfigHelper::get('home_cta_subtitle', 'Use nossos canais para registrar sua denúncia ou acompanhar um caso existente.') }}</p>
            <a href="{{ route('denuncias.formulario-publico') }}" class="btn btn-light btn-lg me-2">
                <i class="fas fa-bullhorn me-2"></i> {{ \App\Helpers\ConfigHelper::get('home_cta_button_text', 'Fazer Denúncia') }}
            </a>
            <a href="{{ route('rastreamento.publico') }}" class="btn btn-outline-light btn-lg">
                <i class="fas fa-search me-2"></i> {{ \App\Helpers\ConfigHelper::get('home_cta_button_secondary', 'Rastrear Denúncia') }}
            </a>
        </div>
    </section>
