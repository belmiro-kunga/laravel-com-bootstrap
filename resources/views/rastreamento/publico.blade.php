            ...
            <div class="col-12 col-md-10 col-lg-8">
                <div class="rastreamento-card animate__animated animate__fadeInUp">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ route('rastreamento.publico.buscar') }}" class="needs-validation" novalidate>
                            <div class="mb-4">
                            ...
                            <div class="d-grid gap-3">
                                ...
                                <a href="{{ route('denuncias.formulario-publico') }}" class="btn btn-outline-primary">
