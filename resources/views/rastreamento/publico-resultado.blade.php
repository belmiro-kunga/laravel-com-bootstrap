...
<body>
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center flex-wrap gap-2">
                                    <div class="protocol-number d-flex align-items-center bg-white bg-opacity-10 px-3 py-2 rounded-pill">
                                        ...
                                        <strong class="me-2">{{ $denuncia->protocolo }}</strong>
                                        <button class="btn btn-sm btn-icon copy-protocol" data-bs-toggle="tooltip" title="Copiar protocolo">
                                            <i class="far fa-copy"></i>
                                        </button>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <span class="status-badge" style="background-color: {{ $denuncia->status->cor }}">
                                            <i class="fas fa-circle me-1" style="font-size: 0.5rem; vertical-align: middle;"></i> {{ $denuncia->status->nome }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="info-card">
                            ...
                            <div class="info-item">
                                ...
                                <span class="info-value">{{ $denuncia->titulo }}</span>
                            </div>
                            ...
                            <div class="info-item">
                                ...
                                <span class="info-value">{{ $denuncia->created_at->format('d/m/Y H:i') }}</span>
                            </div>
                            
                            <div class="info-item">
                                <span class="info-label">Última Atualização:</span>
                                <span class="info-value">{{ $denuncia->updated_at->format('d/m/Y H:i') }}</span>
                            </div>
                            
                            @if($denuncia->responsavel)
                            <div class="info-item">
                                <span class="info-label">Responsável:</span>
                                <span class="info-value">{{ $denuncia->responsavel->name }}</span>
                            </div>
                            @endif
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="timeline">
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-content completed">
                                            ...
                                            <small class="text-success">
                                                <i class="fas fa-check-circle"></i> Concluído em {{ $denuncia->created_at->format('d/m/Y H:i') }}
                                            </small>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Em Análise -->
                                    <div class="timeline-item">
                                        <div class="timeline-marker {{ $denuncia->status->ordem >= 2 ? 'completed' : 'pending' }}">
                                            <i class="fas fa-search"></i>
                                        </div>
                                        <div class="timeline-content {{ $denuncia->status->ordem >= 2 ? 'completed' : 'pending' }}">
                                    ...
                                    <!-- Em Investigação -->
                                    <div class="timeline-item">
                                        <div class="timeline-marker {{ $denuncia->status->ordem >= 3 ? 'completed' : 'pending' }}">
                                            <i class="fas fa-search-plus"></i>
                                        </div>
                                        <div class="timeline-content {{ $denuncia->status->ordem >= 3 ? 'completed' : 'pending' }}">
                                    ...
                                    <!-- Aguardando Decisão -->
                                    <div class="timeline-item">
                                        <div class="timeline-marker {{ $denuncia->status->ordem >= 4 ? 'completed' : 'pending' }}">
                                            <i class="fas fa-gavel"></i>
                                        </div>
                                        <div class="timeline-content {{ $denuncia->status->ordem >= 4 ? 'completed' : 'pending' }}">
                                    ...
                                    <!-- Concluída -->
                                    <div class="timeline-item">
                                        <div class="timeline-marker {{ $denuncia->status->ordem >= 5 ? 'active' : 'pending' }}">
                                            <i class="fas fa-check-double"></i>
                                        </div>
                                        <div class="timeline-content {{ $denuncia->status->ordem >= 5 ? 'active' : 'pending' }}">
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                ...
                                @if($mensagens->count() > 0)
                                    @foreach($mensagens as $comentario)
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <div class="reply ms-4 mb-2">
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="flex-grow-1 ms-2">
                                                                    <div class="d-flex justify-content-between align-items-start">
                                                                        <div>
                                                                            <small class="fw-bold">{{ $resposta->user->email === 'anonimo@sistema.com' ? 'Denunciante' : $resposta->user->name }}</small>
                                                ...
                                                <div class="reply-form mt-3">
                                                    <form action="{{ route('rastreamento.publico.responder', ['protocolo' => $denuncia->protocolo, 'comentario' => $comentario->id]) }}" method="POST">
                                                        @csrf
                        ...
                        <div class="btn-group-action">
                            <a href="{{ route('rastreamento.publico.download', $denuncia->protocolo) }}" class="btn btn-action btn-warning" data-bs-toggle="tooltip" title="Baixar relatório em PDF">
                                <i class="fas fa-file-pdf"></i> Baixar Relatório
                            </a>
                            <a href="{{ route('rastreamento.publico') }}" class="btn btn-action btn-outline-primary" data-bs-toggle="tooltip" title="Fazer uma nova consulta">
                                <i class="fas fa-search"></i> Nova Consulta
                            </a>
                            <a href="{{ route('denuncias.formulario-publico') }}" class="btn btn-action btn-primary" data-bs-toggle="tooltip" title="Criar uma nova denúncia">
                                <i class="fas fa-plus-circle"></i> Nova Denúncia
                            </a>
                            <a href="{{ route('home') }}" class="btn btn-action btn-outline-secondary" data-bs-toggle="tooltip" title="Voltar para a página inicial">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const copyProtocol = () => {
                const protocol = '{{ $denuncia->protocolo }}';
