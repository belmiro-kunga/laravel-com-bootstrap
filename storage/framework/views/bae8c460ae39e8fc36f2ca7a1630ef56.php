...
<head>
    <meta charset="utf-8">
    <title>Relatório de Denúncia - <?php echo e($denuncia->protocolo); ?></title>
    <style>
        body { font-family: DejaVu Sans, sans-serif; color: #222; margin: 0; padding: 0; }
        .header { text-align: center; margin-bottom: 18px; }
        .header h1 { color: #4361ee; font-size: 26px; margin-bottom: 2px; }
        .header .subtitle { font-size: 15px; color: #555; margin-bottom: 2px; }
        .header .generated { font-size: 12px; color: #888; margin-bottom: 10px; }
        .protocolo-box { background: #f4f7ff; border: 1px solid #4361ee; border-radius: 8px; padding: 12px 0; text-align: center; margin-bottom: 18px; }
        .protocolo-box .protocolo { font-size: 22px; font-weight: bold; color: #4361ee; }
        ...
        .status-value { font-weight: bold; color: #fff; background: #4361ee; border-radius: 4px; padding: 2px 10px; }
        ...
        .comment-author { font-weight: bold; color: #4361ee; }
...
<body>
    <div class="header">
        ...
        <div class="subtitle">Relatório de Denúncia</div>
    ...
    <table class="status-table">
        <tr>
            ...
            <td class="status-value" style="background: <?php echo e($denuncia->status->cor ?? '#4361ee'); ?>;"><?php echo e($denuncia->status->nome ?? '-'); ?></td>
        </tr>
        <tr>
    ...
    <div class="footer">
        <div><strong>Sistema de Denúncias Corporativas</strong></div>
