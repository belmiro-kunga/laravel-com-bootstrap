        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="form-container">
                    ...
                    <div class="form-header">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="<?php echo e(route('home')); ?>" class="btn btn-outline-light btn-sm" style="position: relative; z-index: 1000; cursor: pointer;" onclick="window.location.href='<?php echo e(route('home')); ?>'">
                    ...
                    <div class="form-body">
                        ...
                        <div class="alert alert-success animate__animated animate__fadeIn">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="fw-bold"><?php echo e(session('success')); ?></span>
                            </div>
                        </div>
                        <?php endif; ?>
                        
                        <form action="<?php echo e(route('denuncias.salvar-publica')); ?>" method="POST" id="denunciaForm" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-section active" id="step1">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" id="prioridade" name="prioridade" required>
                                        ...
                                        <option value="media" <?php echo e(old('prioridade') == 'media' ? 'selected' : ''); ?>>Média</option>
                            ...
                            <div class="form-section" id="step2">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="descricao" name="descricao" rows="5" required 
                                              placeholder="Descreva detalhadamente o que aconteceu, incluindo datas, locais, pessoas envolvidas..."><?php echo e(old('descricao')); ?></textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="local_ocorrencia" name="local_ocorrencia" 
                                                   value="<?php echo e(old('local_ocorrencia')); ?>" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="data_ocorrencia" name="data_ocorrencia" 
                                                   value="<?php echo e(old('data_ocorrencia')); ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="envolvidos" name="envolvidos" rows="2" 
                                              placeholder="Nomes das pessoas envolvidas (se souber)"><?php echo e(old('envolvidos')); ?></textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="testemunhas" name="testemunhas" rows="2" 
                                              placeholder="Nomes de possíveis testemunhas"><?php echo e(old('testemunhas')); ?></textarea>
                                ...
                                <div class="file-upload-container mb-4">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <textarea class="form-control" id="descricao_comprovativos" name="descricao_comprovativos" 
                                                  rows="3" placeholder="Descreva brevemente o conteúdo dos arquivos anexados..."><?php echo e(old('descricao_comprovativos')); ?></textarea>
                                        <div class="form-text">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nome_denunciante" name="nome_denunciante" 
                                                   value="<?php echo e(old('nome_denunciante')); ?>" placeholder="Seu nome completo">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="email" class="form-control" id="email_denunciante" name="email_denunciante" 
                                                   value="<?php echo e(old('email_denunciante')); ?>" placeholder="seu@email.com">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="tel" class="form-control" id="telefone_denunciante" name="telefone_denunciante" 
                                                   value="<?php echo e(old('telefone_denunciante')); ?>" placeholder="(00) 00000-0000">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="departamento_denunciante" name="departamento_denunciante" 
                                                   value="<?php echo e(old('departamento_denunciante')); ?>" placeholder="Ex: Recursos Humanos">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="text-center mt-4">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="btn btn-outline-light btn-sm">
...
</html> <?php /**PATH C:\Users\Kunga\Documents\GitHub\laravel-com-bootstrap\resources\views/denuncias/formulario-publico.blade.php ENDPATH**/ ?>