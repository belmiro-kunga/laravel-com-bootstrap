...
<?php $__env->startSection('title', 'Rastrear Denúncias'); ?>

<?php $__env->startSection('page-title', 'Rastrear Minhas Denúncias'); ?>
...
<div class="row">
                ...
                <div class="card bg-primary text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h4 class="mb-0"><?php echo e($totalDenuncias); ?></h4>
            ...
            <div class="col-md-3">
                <div class="card bg-warning text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h4 class="mb-0"><?php echo e($denunciasEmAnalise); ?></h4>
            ...
            <div class="col-md-3">
                <div class="card bg-success text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h4 class="mb-0"><?php echo e($denunciasConcluidas); ?></h4>
            ...
            <div class="col-md-3">
                <div class="card bg-danger text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h4 class="mb-0"><?php echo e($denunciasUrgentes); ?></h4>
    ...
    <div class="col-md-12 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('rastreamento.buscar')); ?>" method="GET" class="row g-3">
                    <div class="col-md-8">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('denuncias.formulario-publico')); ?>" class="btn btn-primary btn-sm">
                    <i class="fas fa-plus"></i> Nova Denúncia
                </a>
            </div>
            <div class="card-body">
                <?php if($denuncias->count() > 0): ?>
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <strong><?php echo e($denuncia->protocolo); ?></strong>
                                        <?php if($denuncia->urgente): ?>
                                            <span class="badge bg-danger ms-1">Urgente</span>
                                        <?php endif; ?>
                                    </td>
                                    <td><?php echo e(Str::limit($denuncia->titulo, 50)); ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('rastreamento.show', $denuncia->protocolo)); ?>" 
                                           class="btn btn-sm btn-outline-primary" title="Ver Detalhes">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <button class="btn btn-sm btn-outline-info" 
                                                onclick="verificarStatus('<?php echo e($denuncia->protocolo); ?>')" 
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel com bootstrap\resources\views/rastreamento/index.blade.php ENDPATH**/ ?>